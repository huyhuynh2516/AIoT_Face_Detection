# AIoT Face Detection System – ESP32-CAM + Blynk
A smart AIoT surveillance system using ESP32-CAM that can detect motion and human faces, capture an image, and send it to the Blynk IoT App in real-time.  
This project demonstrates embedded programming, IoT communication, image processing, and cloud integration.
